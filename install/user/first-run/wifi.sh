notify_update() {
  omisu-notification-send -u critical -g  "Update System" "Click to update the system." \
    --exec omisu-launch-floating-terminal-with-presentation omisu-update
}

notify_wifi() {
  omisu-notification-send -u critical -g 󰖩 "Setup Wi-Fi" "Click to configure the wireless network." \
    --exec omisu-shell shell toggle omisu.network
}
