...
locate_config_script="$OMISU_PATH/install/config/locate.sh"
UPDATEDB_CONF_PATH="${OMISU_UPDATEDB_CONF_PATH:-/etc/updatedb.conf}"
...
as_root env OMISU_UPDATEDB_CONF_PATH="$UPDATEDB_CONF_PATH" bash -euo pipefail "$locate_config_script"
