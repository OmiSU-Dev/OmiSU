echo "Move current OmiSu theme state to ~/.local/state"

legacy_current_dir="$HOME/.config/omisu/current"
current_state_dir="$HOME/.local/state/omisu/current"
...
replace_current_path() {
  ...
  replace_literal_in_file "$file" "$HOME/.config/omisu/current" "$HOME/.local/state/omisu/current"
  replace_literal_in_file "$file" "~/.config/omisu/current" "~/.local/state/omisu/current"
  replace_literal_in_file "$file" "../omisu/current" "../../.local/state/omisu/current"
}
...
relink_current_symlink() {
  ...
  case "$target" in
    ...
    "~/.config/omisu/current/"*)
      ...
      suffix=${target#"~/.config/omisu/current/"}
      ln -sfn "$current_state_dir/$suffix" "$link"
      ;;
  esac
}
...
for link in \
  ...
  "$HOME/.config/helix/themes/omisu.toml" \
  "$HOME/.vscode/extensions/omisu-theme/themes/omisu-color-theme.json" \
  "$HOME/.vscode-insiders/extensions/omisu-theme/themes/omisu-color-theme.json" \
  "$HOME/.vscode-oss/extensions/omisu-theme/themes/omisu-color-theme.json" \
  "$HOME/.cursor/extensions/omisu-theme/themes/omisu-color-theme.json"; do
