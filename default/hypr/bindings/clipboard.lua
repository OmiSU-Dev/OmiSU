...
-- layer-shell surfaces such as OmiSu panels. A virtual keyboard (wtype) won't
...
o.bind("SUPER + CTRL + V", "Clipboard manager", "omisu-shell shell toggle omisu.clipboard")
