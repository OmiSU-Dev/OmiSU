...
o.window(
  "(org.omisu.btop|org.omisu.terminal|org.omisu.bash|org.codeberg.dnkl.foot|org.gnome.NautilusPreviewer|org.gnome.Evince|OmiSu|About|TUI.float|imv|mpv)",
  {
    tag = "+floating-window",
  }
)
...
-- This size only covers the first launch: omisu-launch-about measures the
-- rendered content, remembers the size that hugs it, and applies that as its own
-- rule before every later launch.
o.window("org.omisu.about", { float = true })
o.window("org.omisu.about", { center = true })
o.window("org.omisu.about", { size = { 920, 480 } })
...
o.window("org.omisu.screensaver", { fullscreen = true })
o.window("org.omisu.screensaver", { float = true })
o.window("org.omisu.screensaver", { animation = "slide" })
