...
local nvidia = paths.omisu_path .. "/bin/omisu-hw-nvidia"
local nvidia_gsp = paths.omisu_path .. "/bin/omisu-hw-nvidia-gsp"
local nvidia_without_gsp = paths.omisu_path .. "/bin/omisu-hw-nvidia-without-gsp"
