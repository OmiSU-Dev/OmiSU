...
-- Used for OmiSu extension-style folders such as default/hypr/apps,
-- default/hypr/bindings, and ~/.local/state/omisu/toggles/hypr.
-- Pass a module prefix for normal package.path modules, e.g.
--   require_all.files(paths.omisu_path .. "/default/hypr/apps", "default.hypr.apps")
