...
description: >
  ...
  Covers reporting a confirmed OmiSu bug upstream — see reporting.md.
---
...
## If it is an OmiSu bug

Most application crashes are upstream bugs in those applications, not OmiSu's
doing. In the minority of cases where the cause really does sit within OmiSu's
