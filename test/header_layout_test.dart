...
void main() {
  group('navStripWidth', () {
    ...
    test('can omit shoulders when bumpers sit on a separate header row', () {
      expect(navStripWidth(tabCount: 4, includeShoulders: false), 136);
      expect(navStripWidth(tabCount: 4), 136 + 72);
    });
  });

  group('navTabPillWidth', () {
    test('is only the pill padding and slots', () {
      expect(navTabPillWidth(tabCount: 0), 8);
      expect(navTabPillWidth(tabCount: 6), 200);
    });
  });

  group('navStripWidth increments', () {
