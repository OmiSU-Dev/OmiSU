...
[[ $editor == "omisu-launch-editor --inline" ]] || fail "bash env provides a default editor" "actual: $editor"
...
[[ $sudo_editor == "omisu-launch-editor --inline" ]] || fail "sudo uses the default editor" "actual: $sudo_editor"
