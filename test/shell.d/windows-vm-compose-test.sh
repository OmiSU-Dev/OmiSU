...
export OMISU_WINDOWS_DIR="$TMPDIR/win"

# Source the command's functions; the dispatcher just prints usage for "help".
set -- help
source "$ROOT/bin/omisu-windows-vm" >/dev/null 2>&1
COMPOSE="$OMISU_WINDOWS_DIR/docker-compose.yml"
...
for p in /home/u/.windows /var/lib/omisu/windows; do
