...
ShellRoot {
  ...
  function widgets() {
    try {
      return JSON.parse(Qt.atob(Quickshell.env("OMISU_QML_BAR_WIDGETS") || "W10="))
    } catch (error) {
  ...
  QtObject {
    ...
    property string omisuPath: root.rootPath
