...
def run():
  event_path = os.environ["OMISU_TRAY_MENU_EVENT_RESULT"]
  ready_path = os.environ["OMISU_TRAY_MENU_READY"]

  DBusGMainLoop(set_as_default=True)
  bus = dbus.SessionBus()
  dbus.service.BusName("org.omisu.TestStatusNotifier", bus)
