...
flag="$test_home/.local/state/omisu/toggles/example"
bar_flag="$test_home/.local/state/omisu/toggles/bar-off"

HOME="$test_home" omisu-toggle example on
...
HOME="$test_home" omisu-toggle-bar off
