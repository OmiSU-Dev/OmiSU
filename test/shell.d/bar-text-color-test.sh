...
result=$(HOME="$TMPDIR" omisu-bar-text-color top 20 '#ffffff' '#101010' --background "$light_top" --screen 100x100)
...
result=$(HOME="$TMPDIR" omisu-bar-text-color top 20 '#ffffff' '#101010' --background "$dark_top" --screen 100x100)
...
result=$(HOME="$TMPDIR" omisu-bar-text-color top 20 '#ffffff' '#101010' --background "$TMPDIR/missing.png" --screen 100x100)
