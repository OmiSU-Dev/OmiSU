...
QtObject {
  ...
  readonly property string currentThemePath: stateHome + "/omisu/current/theme"
  ...
  // Style. User keys win, so a machine-level `~/.config/omisu/shell.toml`
