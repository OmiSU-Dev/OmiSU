...
// omisu-disk-speedtest run streams both phases and cleans up after itself,
...
Item {
  ...
  function dismiss() {
    if (shell && typeof shell.hide === "function")
      shell.hide((manifest && manifest.id) || "omisu.disk-speedtest")
    else close()
  }
  ...
  SpeedTestOverlay {
    ...
    layerNamespace: "omisu-disk-speedtest"
    title: root.diskName
    leftLabel: "READ"
    rightLabel: "WRITE"
    unit: "MB/s"
