...
Item {
  ...
  Process {
    id: laptopClosedProc
    command: ["bash", "-c", "omisu-hw-laptop-closed && echo closed || echo open"]
  ...
  PolkitAgent {
    ...
    onIsRegisteredChanged: {
      if (isRegistered) console.log("omisu polkit agent registered")
      else console.warn("omisu polkit agent is not registered; another agent may be running")
    }
  }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "omisu-polkit"
