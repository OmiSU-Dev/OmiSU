...
BarWidget {
  ...
  // UseQApplication` - omisu's shell.qml does not, so every submenu click was
  ...
  function persistTrayState(pinned, hidden) {
    ...
    var id = root.moduleName || "omisu.tray"
