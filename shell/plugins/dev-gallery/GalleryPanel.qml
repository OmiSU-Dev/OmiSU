...
// Visual reference + live playground for omisu-shell's common UI
// components. Summon with `omisu dev ui-preview`, or directly via:
//   omisu-shell shell summon omisu.dev-gallery "{}"
//
...
Item {
  ...
  function open(payloadJson) {
    ...
    // Optional { section: "button" } in the payload lets `omisu dev
  ...
  function requestClose() {
    if (shell && typeof shell.hide === "function") shell.hide("omisu.dev-gallery")
  ...
  FloatingWindow {
    ...
    onVisibleChanged: {
      if (!visible && !root.closingFromHost && root.shell && typeof root.shell.hide === "function")
        root.shell.hide("omisu.dev-gallery")
    }
          ...
          Column {
            ...
            Text {
              text: "Style.font.* is the shell-wide type scale. Themes ship a single "
                ...
                + "set it with `omisu font set <name>`."
            ...
            BorderSurface {
              ...
              Column {
                ...
                Dropdown {
                  ...
                  label: "Center anchor"
                  fontFamily: root.fontFamily
                  options: ["omisu.clock", "omisu.weather", "omisu.power"]
              ...
              Column {
                ...
                SearchableDropdown {
                  ...
                  options: [
                    ...
                    { value: "omisu.power", label: "Power", description: "Charge level + power profile" },
                    ...
                    { value: "omisu-menu", label: "OmiSu menu", description: "Launcher / system menu" },
