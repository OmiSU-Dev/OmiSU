...
Item {
  ...
  // Injected by omisu-shell; defaults to the session OMISU_PATH.
  property string omisuPath: Quickshell.env("OMISU_PATH")
  property string stateHome: Quickshell.env("HOME") + "/.local/state"
  property string imageDirs: Quickshell.env("OMISU_IMAGE_SELECTOR_DIRS") || Quickshell.env("OMISU_IMAGE_SELECTOR_DIR") || Quickshell.env("OMISU_STOCK_BACKGROUNDS_DIR") || (stateHome + "/omisu/current/theme/backgrounds")
  property string imageRows: ""
  property string loadedImageRows: ""
  property string selectionFile: Quickshell.env("OMISU_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("OMISU_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("OMISU_IMAGE_SELECTOR_SELECTED")
  ...
  function scriptPath(name) {
    return omisuPath + "/shell/plugins/image-picker/" + name
  }
  ...
  // Lifecycle hooks invoked by omisu-shell summon/hide. shell.summon(id,
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "omisu-image-selector"
