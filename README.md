...
OmiSu is a beautiful, modern & opinionated Linux distribution by DHH.

Read more at [omisu.org](https://omisu.org).

## The OmiSu Manual

The manual lives in [`manual/`](manual/), which is its authoritative source. It's
mirrored to [learn.omacom.io](https://learn.omacom.io/2/the-omisu-manual), where
its screenshots are also hosted.

- [Welcome to OmiSu!](manual/01-welcome-to-omisu.md)
...
- [OmiSu CLI](manual/14-omisu-cli.md)
...
- [OmiSu on...](manual/49-omisu-on.md)
- [Dual Boot Install](manual/50-dual-boot-install.md)
- [Unattended Installs](manual/51-unattended-installs.md)

## License

OmiSu is released under the [MIT License](https://opensource.org/licenses/MIT).
