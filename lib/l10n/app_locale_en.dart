...
const Map<String, dynamic> appLocaleEn = {
  ...
  AppLocale.startupStorageUnavailable:
      'OmiSU could not reach the folder where your data is stored. Check that the SD card or drive is connected.',
  ...
  AppLocale.bootPromptBoot: '> boot_',
  AppLocale.bootDetailBoot: 'Starting OmiSU...',
  AppLocale.bootPromptMemory: '> tune cache_',
  AppLocale.bootDetailMemory: 'Sizing image cache for this device...',
  AppLocale.bootPromptStorage: '> mount storage_',
  AppLocale.bootDetailStorage: 'Waiting for user-data storage...',
  AppLocale.bootPromptShell: '> init shell_',
  AppLocale.bootDetailShell: 'Preparing window and input...',
  AppLocale.bootPromptLibrary: '> open library_',
  AppLocale.bootDetailLibrary: 'Loading database and ROM index...',
  AppLocale.bootPromptTheme: '> load theme_',
  AppLocale.bootDetailTheme: 'Applying saved appearance...',
  AppLocale.bootPromptServices: '> start services_',
  ...
  AppLocale.themesSubtitle: 'Personalize the appearance of your OmiSU',
  ...
  AppLocale.ambientBackdrop: 'Ambient backdrop',
  AppLocale.ambientBackdropSubtitle:
      'Pixel dust and Omarchy screensaver ASCII behind the home grid',
  AppLocale.ambientBackdropOff: 'Off',
  AppLocale.ambientBackdropSubtle: 'Subtle',
  AppLocale.ambientBackdropReactive: 'Reactive',
  AppLocale.ambientBackdropScreensaver: 'Screensaver',
  ...
  AppLocale.autoUpdateApp: 'Check for updates on launch',
  AppLocale.autoUpdateAppSubtitle:
      'On startup, check for a newer app build over Wi‑Fi (when published) and prompt to install',
  AppLocale.autoUpdateSystems: 'Auto-update player & systems on launch',
  ...
  AppLocale.defaultLauncherSubtitle: 'OmiSU is your default launcher',
  AppLocale.isDefaultLauncher: 'OmiSU is your default launcher',
  AppLocale.setAsDefaultLauncher: 'Set OmiSU as your home screen',
  ...
  AppLocale.exitConfirmation: 'Are you sure you want to exit OmiSU?',
  ...
  AppLocale.thankYou: 'Thank you for using OmiSU!',
  ...
  AppLocale.neoSyncDescription:
      'NeoSync is your unified cloud companion for OmiSU. It securely synchronizes your game saves, and game states across all your devices, ensuring your progress is never lost.',
  AppLocale.crossPlatform: 'Cross-Platform',
  AppLocale.crossPlatformDesc:
      'Pick up exactly where you left off on any device running OmiSU.',
  ...
  AppLocale.embeddedPlayDesktopDetails:
      'OmiSU plays Game Boy, NES, SNES, and other supported systems inside the app '
      'using built-in libretro cores — the same engine Lemuroid uses, with no extra '
      'emulator app to install. That player is only in the Android APK, not in this '
      'Linux desktop preview. Install OmiSU on your phone or tablet to play; use '
      'this preview for library setup and artwork only.',
  ...
  AppLocale.folderNotEmptyBody:
      'This folder already contains {count} item(s). OmiSU will store its own data here, alongside the existing contents.',
  ...
  AppLocale.userDataFolderGrantAllFiles:
      "To use this folder, allow All files access for OmiSU in Android Settings → Apps → Special app access → All files access, then pick it again.",
  AppLocale.moveUserDataTitle: 'Move User Data?',
  AppLocale.moveUserDataBody:
      'OmiSU will move its own data — database, scraped media, and settings — from the current folder to the new one. Files not created by OmiSU are left untouched.',
  AppLocale.moveUserDataDestNotEmpty:
      'The new folder already contains {count} item(s). OmiSU data will be added alongside them.',
  ...
  AppLocale.restartRequiredBody:
      'OmiSU will close now. Please reopen it to use the new location.',
  ...
  AppLocale.servicesSubtitle:
      'Connect online libraries and sync — games play from your list with built-in cores',
  ...
  AppLocale.streamingFaceCamSubtitle:
      'Front camera preview and overlay on the stream',
  ...
  AppLocale.homeLayout: 'Home layout',
  AppLocale.homeLayoutSubtitle: 'Grid shows your library at a glance; carousel is a showcase view',
  ...
  AppLocale.rommNoWritableFolder:
      'Could not write to your ROM folder. Grant "All files access" to OmiSU and try again.',
  ...
  AppLocale.wizardArtPackTitle: 'Get the OmiSU Art Pack',
  AppLocale.wizardArtPackDesc:
      'We strongly recommend downloading the OmiSU system art pack for '
