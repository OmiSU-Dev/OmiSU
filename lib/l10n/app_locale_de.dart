...
const Map<String, dynamic> appLocaleDe = {
  ...
  AppLocale.startupStorageUnavailable:
      'OmiSU konnte den Ordner mit deinen Daten nicht erreichen. Prüfe, ob die SD-Karte oder das Laufwerk angeschlossen ist.',
  AppLocale.startupStorageRetry: 'Erneut versuchen',
  AppLocale.startupStorageUseDefault: 'Ohne fortfahren',
  AppLocale.startupLoading:
      'OmiSU wird vorbereitet. Warte auf Speicher und Dienste…',
  ...
  AppLocale.themesSubtitle: 'Personalisiere das Design von OmiSU',
  ...
  AppLocale.defaultLauncherSubtitle: 'OmiSU ist dein Standard-Launcher',
  AppLocale.isDefaultLauncher: 'OmiSU ist dein Standard-Launcher',
  AppLocale.setAsDefaultLauncher: 'OmiSU als Startbildschirm festlegen',
  ...
  AppLocale.exitConfirmation:
      'Bist du sicher, dass du OmiSU beenden möchtest?',
  ...
  AppLocale.thankYou: 'Danke, dass du OmiSU benutzt!',
  ...
  AppLocale.neoSyncDescription:
      'NeoSync ist der einheitliche Cloud-Partner für dein OmiSU.',
  AppLocale.crossPlatform: 'Plattformübergreifend',
  AppLocale.crossPlatformDesc:
      'Mache da weiter, wo du aufgehört hast, auf jedem OmiSU-Gerät.',
  ...
  AppLocale.welcomeOmiSU: 'Willkommen bei OmiSU!',
  ...
  AppLocale.storagePermissionDesc:
      'OmiSU benötigt "Zugriff auf alle Dateien", um deine RetroArch-Konfigurationen zu verwalten und deine Spielstände korrekt zu synchronisieren.\n\nBitte erteile diese Berechtigung im nächsten Bildschirm.',
  ...
  AppLocale.folderNotEmptyBody:
      'Dieser Ordner enthält bereits {count} Element(e). OmiSU speichert seine eigenen Daten hier, zusammen mit den vorhandenen Inhalten.',
  ...
  AppLocale.userDataFolderGrantAllFiles:
      "Um diesen Ordner zu nutzen, erlaube OmiSU den Zugriff auf alle Dateien unter Android-Einstellungen → Apps → Spezieller App-Zugriff → Zugriff auf alle Dateien und wähle ihn dann erneut.",
  AppLocale.moveUserDataTitle: 'Benutzerdaten verschieben?',
  AppLocale.moveUserDataBody:
      'OmiSU verschiebt seine eigenen Daten – Datenbank, gescrapte Medien und Einstellungen – vom aktuellen Ordner in den neuen. Dateien, die nicht von OmiSU erstellt wurden, bleiben unberührt.',
  AppLocale.moveUserDataDestNotEmpty:
      'Der neue Ordner enthält bereits {count} Element(e). Die Daten von OmiSU werden daneben abgelegt.',
  ...
  AppLocale.restartRequiredBody:
      'OmiSU wird jetzt geschlossen. Bitte neu öffnen, um den neuen Speicherort zu verwenden.',
  ...
  AppLocale.services: 'Dienste',
  AppLocale.servicesSubtitle:
      'Online-Bibliotheken verbinden und synchronisieren — Spiele starten nativ aus deiner Liste',
  AppLocale.servicesEmbeddedPlayNote:
      'OmiSU startet Spiele nativ. Für unterstützte Systeme ist kein zusätzlicher Emulator nötig.',
  ...
  AppLocale.homeLayout: 'Startlayout',
  AppLocale.homeLayoutSubtitle:
      'Raster zeigt die Bibliothek auf einen Blick; Karussell ist eine Präsentationsansicht',
  ...
  AppLocale.rommNoWritableFolder:
      'Dein ROM-Ordner konnte nicht beschrieben werden. Erteile OmiSU "Zugriff auf alle Dateien" und versuche es erneut.',
  ...
  AppLocale.wizardArtPackTitle: 'Hol dir das OmiSU-Artwork-Paket',
  AppLocale.wizardArtPackDesc:
      'Wir empfehlen dringend, das OmiSU-System-Artwork-Paket '
