...
const Map<String, dynamic> appLocaleRu = {
  ...
  AppLocale.startupStorageUnavailable:
      'OmiSU не удалось получить доступ к папке с вашими данными. Убедитесь, что SD-карта или накопитель подключены.',
  AppLocale.startupStorageRetry: 'Повторить',
  AppLocale.startupStorageUseDefault: 'Продолжить без неё',
  AppLocale.startupLoading:
      'Подготовка OmiSU. Ожидание хранилища и служб...',
  ...
  AppLocale.themesSubtitle: 'Персонализируйте внешний вид вашей OmiSU',
  ...
  AppLocale.defaultLauncherSubtitle: 'OmiSU — ваш лаунчер по умолчанию',
  AppLocale.isDefaultLauncher: 'OmiSU — ваш лаунчер по умолчанию',
  AppLocale.setAsDefaultLauncher: 'Установить OmiSU как домашний экран',
  ...
  AppLocale.exitConfirmation: 'Вы уверены, что хотите выйти из OmiSU?',
  ...
  AppLocale.thankYou: 'Спасибо за использование OmiSU!',
  ...
  AppLocale.neoSyncDescription:
      'NeoSync — ваш единый облачный помощник для OmiSU.',
  ...
  AppLocale.welcomeOmiSU: 'Добро пожаловать в OmiSU!',
  ...
  AppLocale.storagePermissionDesc:
      'OmiSU нужен «Доступ ко всем файлам» для управления конфигурациями RetroArch.',
  ...
  AppLocale.folderNotEmptyBody:
      'Эта папка уже содержит {count} элемент(ов). OmiSU будет хранить свои данные здесь, рядом с существующим содержимым.',
  ...
  AppLocale.userDataFolderGrantAllFiles:
      "Чтобы использовать эту папку, разрешите OmiSU доступ ко всем файлам в настройках Android → Приложения → Специальный доступ → Доступ ко всем файлам, затем выберите её снова.",
  AppLocale.moveUserDataTitle: 'Переместить данные пользователя?',
  AppLocale.moveUserDataBody:
      'OmiSU переместит свои данные (базу данных, загруженные медиа и настройки) из текущей папки в новую. Файлы, созданные не OmiSU, останутся нетронутыми.',
  AppLocale.moveUserDataDestNotEmpty:
      'Новая папка уже содержит {count} элемент(ов). Данные OmiSU будут добавлены рядом с ними.',
  ...
  AppLocale.restartRequiredBody:
      'OmiSU сейчас закроется. Откройте снова, чтобы использовать новое расположение.',
  ...
  AppLocale.services: 'Сервисы',
  AppLocale.servicesSubtitle:
      'Подключайте онлайн-библиотеки и синхронизацию — игры запускаются из списка со встроенными ядрами',
  AppLocale.servicesEmbeddedPlayNote:
      'OmiSU запускает игры нативно. Дополнительный эмулятор для поддерживаемых систем не требуется.',
  ...
  AppLocale.homeLayout: 'Макет главной',
  AppLocale.homeLayoutSubtitle:
      'Сетка показывает библиотеку; карусель — витринный режим',
  ...
  AppLocale.rommNoWritableFolder:
      'Не удалось записать в папку с ROM. Предоставьте OmiSU «Доступ ко всем файлам» и повторите попытку.',
  ...
  AppLocale.wizardEsdeStepDesc:
      ...
      'Настройках.',
  AppLocale.wizardArtPackTitle: 'Получите набор обложек OmiSU',
  AppLocale.wizardArtPackDesc:
      'Мы настоятельно рекомендуем загрузить набор системных обложек OmiSU '
