...
const Map<String, dynamic> appLocaleZhHant = {
  ...
  AppLocale.startupStorageUnavailable:
      'OmiSU 無法存取儲存資料的資料夾。請確認 SD 卡或儲存裝置已連接。',
  AppLocale.startupStorageRetry: '重試',
  AppLocale.startupStorageUseDefault: '繼續（不使用）',
  AppLocale.startupLoading: '正在準備 OmiSU，等待儲存空間與服務就緒…',
  ...
  AppLocale.themesSubtitle: '個人化您的 OmiSU 外觀',
  ...
  AppLocale.neoglassTransparencySubtitle: '0 = 無透明度，30 = 50% 透明度',
  ...
  AppLocale.updatesCheckFailed: '更新檢查失敗，請檢查 Wi‑Fi 後重試。',
  ...
  AppLocale.defaultLauncherSubtitle: 'OmiSU 是您的預設啟動器',
  AppLocale.isDefaultLauncher: 'OmiSU 是您的預設啟動器',
  AppLocale.setAsDefaultLauncher: '將 OmiSU 設為預設啟動器',
  ...
  AppLocale.exitConfirmation: '您確定要離開 OmiSU 嗎？',
  ...
  AppLocale.thankYou: '感謝您使用 OmiSU！',
  ...
  AppLocale.neoSyncDescription: 'NeoSync 是您 OmiSU 的統一雲端夥伴。',
  AppLocale.crossPlatform: '跨平台',
  AppLocale.crossPlatformDesc: '在任何執行 OmiSU 的裝置上無縫繼續遊戲。',
  ...
  AppLocale.chooseRomFolderDesc: '選擇儲存 ROM 檔案的資料夾。OmiSU 將掃描其中的遊戲。',
  ...
  AppLocale.updateReleaseNotesTitle: '更新內容',
  AppLocale.updateNoReleaseNotes: '此更新未提供發行說明。',
  AppLocale.updateKnownIssueWarning:
      '發行說明提到已知問題 — 更新前請先閱讀下方內容。',
  AppLocale.builtinPlayerUpdateAvailable: '內建播放器更新',
  ...
  AppLocale.folderNotEmptyBody:
      '此資料夾已包含 {count} 個項目。OmiSU 會將自己的資料儲存在此處，與現有內容放在一起。',
  ...
  AppLocale.userDataFolderGrantAllFiles:
      "若要使用此資料夾，請在 Android 設定 → 應用程式 → 特殊應用程式存取權 → 所有檔案存取權 中允許 OmiSU，然後重新選擇。",
  AppLocale.moveUserDataTitle: '移動使用者資料？',
  AppLocale.moveUserDataBody:
      'OmiSU 會將自己的資料（資料庫、抓取的媒體和設定）從目前的資料夾移動到新的資料夾。非 OmiSU 建立的檔案不會被更動。',
  AppLocale.moveUserDataDestNotEmpty:
      '新資料夾已包含 {count} 個項目。OmiSU 的資料將新增在它們旁邊。',
  ...
  AppLocale.restartRequiredBody: 'OmiSU 即將關閉，請重新開啟以使用新位置。',
  ...
  AppLocale.services: '服務',
  AppLocale.servicesSubtitle: '連接線上庫並同步 — 遊戲從清單原生啟動，內建核心',
  AppLocale.servicesEmbeddedPlayNote: 'OmiSU 原生啟動遊戲。支援的系統無需額外下載模擬器。',
  ...
  AppLocale.homeLayout: '主頁版面',
  AppLocale.homeLayoutSubtitle: '網格一覽資料庫；輪播為展示檢視',
  ...
  AppLocale.rommSearchClear: '清除搜尋',
  ...
  AppLocale.rommNoWritableFolder:
      '無法寫入你的 ROM 資料夾。請授予 OmiSU「所有檔案存取權限」後再試一次。',
  ...
  AppLocale.wizardArtPackTitle: '取得 OmiSU 美術包',
  AppLocale.wizardArtPackDesc:
      '我們強烈建議下載 OmiSU 系統美術包，為你的整個遊戲庫帶來精美的'
      '主機背景。之後可在「設定」中變更。',
