...
const Map<String, dynamic> appLocaleKo = {
  ...
  AppLocale.startupStorageUnavailable:
      'OmiSU이 데이터가 저장된 폴더에 접근하지 못했습니다. SD 카드나 드라이브가 연결되어 있는지 확인하세요.',
  AppLocale.startupStorageRetry: '다시 시도',
  AppLocale.startupStorageUseDefault: '이대로 계속',
  AppLocale.startupLoading: 'OmiSU을 준비 중입니다. 저장소와 서비스를 기다리고 있습니다…',
  ...
  AppLocale.themesSubtitle: 'OmiSU의 화면을 원하는 스타일로 꾸밉니다',
  ...
  AppLocale.neoglassTransparencySubtitle: '0 = 투명 없음, 30 = 50% 투명',
  ...
  AppLocale.updatesUpToDate: '모두 최신 버전입니다',
  AppLocale.updatesCheckFailed:
      '업데이트 확인에 실패했습니다. Wi‑Fi 연결을 확인한 후 다시 시도하세요.',
  ...
  AppLocale.defaultLauncherSubtitle: 'OmiSU이 기본 런처로 설정되어 있습니다',
  AppLocale.isDefaultLauncher: 'OmiSU이 기본 런처입니다',
  AppLocale.setAsDefaultLauncher: 'OmiSU을 홈 화면으로 설정',
  ...
  AppLocale.exitConfirmation: 'OmiSU을 종료하시겠습니까?',
  ...
  AppLocale.thankYou: 'OmiSU을 이용해 주셔서 감사합니다!',
  ...
  AppLocale.neoSyncDescription:
      'NeoSync는 OmiSU용 통합 클라우드 서비스입니다. 여러 기기에서 게임 세이브와 세이브 상태를 안전하게 동기화해 진행 상황을 보호합니다.',
  AppLocale.crossPlatform: '크로스 플랫폼',
  AppLocale.crossPlatformDesc:
      'OmiSU이 설치된 어느 기기에서든 마지막으로 플레이한 지점부터 이어서 할 수 있습니다.',
  ...
  AppLocale.updateReleaseNotesTitle: '변경 사항',
  AppLocale.updateNoReleaseNotes: '이 업데이트에 대한 릴리스 노트가 없습니다.',
  AppLocale.updateKnownIssueWarning:
      '릴리스 노트에 알려진 문제가 언급되어 있습니다. 업데이트 전에 아래를 확인하세요.',
  AppLocale.builtinPlayerUpdateAvailable: '내장 플레이어 업데이트',
  AppLocale.builtinPlayerEngineLabel: 'LibretroDroid 엔진',
  AppLocale.builtinPlayerCoresLabel: 'Libretro 코어',
  ...
  AppLocale.folderNotEmptyBody:
      '이 폴더에는 이미 {count}개의 항목이 포함되어 있습니다. OmiSU은 기존 콘텐츠와 함께 여기에 자체 데이터를 저장합니다.',
  ...
  AppLocale.userDataFolderGrantAllFiles:
      "이 폴더를 사용하려면 Android 설정 → 애플리케이션 → 특별한 앱 액세스 → 모든 파일 액세스에서 OmiSU을 허용한 후 다시 선택하세요.",
  AppLocale.moveUserDataTitle: '사용자 데이터를 이동하시겠습니까?',
  AppLocale.moveUserDataBody:
      'OmiSU은 자체 데이터(데이터베이스, 스크랩한 미디어, 설정)를 현재 폴더에서 새 폴더로 이동합니다. OmiSU에서 생성되지 않은 파일은 그대로 유지됩니다.',
  AppLocale.moveUserDataDestNotEmpty:
      '새 폴더에는 이미 {count}개의 항목이 포함되어 있습니다. OmiSU 데이터도 함께 추가됩니다.',
  ...
  AppLocale.restartRequiredBody: '이제 OmiSU이 종료됩니다. 새 위치를 사용하려면 다시 열어주세요.',
  ...
  AppLocale.services: '서비스',
  AppLocale.servicesSubtitle:
      '온라인 라이브러리 연결 및 동기화 — 게임은 목록에서 네이티브 실행, 코어 내장',
  AppLocale.servicesEmbeddedPlayNote:
      'OmiSU는 게임을 네이티브로 실행합니다. 지원 시스템에는 추가 에뮬레이터 다운로드가 필요 없습니다.',
  ...
  AppLocale.homeLayout: '홈 레이아웃',
  AppLocale.homeLayoutSubtitle: '그리드는 라이브러리 한눈에, 캐러셀은 쇼케이스 보기',
  ...
  AppLocale.rommSearchClear: '검색 지우기',
  ...
  AppLocale.rommNoWritableFolder:
      'ROM 폴더에 쓸 수 없습니다. OmiSU에 "모든 파일 액세스" 권한을 허용한 후 다시 시도하세요.',
  ...
  AppLocale.wizardArtPackTitle: 'OmiSU 아트 팩 받기',
  AppLocale.wizardArtPackDesc:
      '라이브러리 전체에 아름다운 콘솔 배경을 제공하는 OmiSU 시스템 '
