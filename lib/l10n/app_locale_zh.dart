...
const Map<String, dynamic> appLocaleZh = {
  ...
  AppLocale.startupStorageUnavailable:
      'OmiSU 无法访问保存数据的文件夹。请确认 SD 卡或存储设备已连接。',
  AppLocale.startupStorageRetry: '重试',
  AppLocale.startupStorageUseDefault: '继续（不使用）',
  AppLocale.startupLoading: '正在准备 OmiSU，等待存储和服务就绪…',
  ...
  AppLocale.themesSubtitle: '个性化您的 OmiSU 外观',
  ...
  AppLocale.neoglassTransparencySubtitle: '0 = 无透明度，30 = 50% 透明度',
  ...
  AppLocale.checkForUpdatesNowSubtitle:
      'LibretroDroid 引擎与 libretro 核心（Nordi 应用请通过电脑安装，非 NeoStation GitHub）',
  ...
  AppLocale.updatesUpToDate: '已全部是最新版本',
  AppLocale.updatesCheckFailed: '更新检查失败，请检查 Wi‑Fi 后重试。',
  ...
  AppLocale.defaultLauncherSubtitle: 'OmiSU 是您的默认启动器',
  AppLocale.isDefaultLauncher: 'OmiSU 是您的默认启动器',
  AppLocale.setAsDefaultLauncher: '将 OmiSU 设置为默认启动器',
  ...
  AppLocale.exitConfirmation: '您确定要退出 OmiSU 吗？',
  ...
  AppLocale.thankYou: '感谢您使用 OmiSU！',
  ...
  AppLocale.neoSyncDescription: 'NeoSync 是您 OmiSU 的统一云端伙伴。',
  AppLocale.crossPlatform: '跨平台',
  AppLocale.crossPlatformDesc: '在任何运行 OmiSU 的设备上无缝继续游戏。',
  ...
  AppLocale.chooseRomFolderDesc: '选择存储 ROM 文件的文件夹。OmiSU 将扫描其中的游戏。',
  ...
  AppLocale.updateReleaseNotesTitle: '更新内容',
  AppLocale.updateNoReleaseNotes: '此更新未提供发行说明。',
  AppLocale.updateKnownIssueWarning:
      '发行说明提到已知问题 — 更新前请先阅读下方内容。',
  AppLocale.builtinPlayerUpdateAvailable: '内置播放器更新',
  AppLocale.builtinPlayerEngineLabel: 'LibretroDroid 引擎',
  AppLocale.builtinPlayerCoresLabel: 'Libretro 核心',
  ...
  AppLocale.folderNotEmptyBody:
      '此文件夹已包含 {count} 个项目。OmiSU 会将自己的数据存储在此处，与现有内容放在一起。',
  AppLocale.folderNotEmptyUseAnyway: '仍然使用',
  AppLocale.userDataFolderNotWritable: "无法写入此文件夹。请选择其他文件夹，或保留默认位置。",
  AppLocale.userDataFolderGrantAllFiles:
      "要使用此文件夹，请在 Android 设置 → 应用 → 特殊应用权限 → 所有文件访问权限 中允许 OmiSU，然后重新选择。",
  AppLocale.moveUserDataTitle: '移动用户数据？',
  AppLocale.moveUserDataBody:
      'OmiSU 会将自己的数据（数据库、抓取的媒体和设置）从当前文件夹移动到新文件夹。非 OmiSU 创建的文件不会被改动。',
  AppLocale.moveUserDataDestNotEmpty:
      '新文件夹已包含 {count} 个项目。OmiSU 的数据将添加在它们旁边。',
  ...
  AppLocale.restartRequiredBody: 'OmiSU 即将关闭，请重新打开以使用新位置。',
  ...
  AppLocale.services: '服务',
  AppLocale.servicesSubtitle: '连接在线库并同步 — 游戏从列表原生启动，内置核心',
  AppLocale.servicesEmbeddedPlayNote: 'OmiSU 原生启动游戏。支持的系统无需额外下载模拟器。',
  ...
  AppLocale.homeLayout: '主页布局',
  AppLocale.homeLayoutSubtitle: '网格一览库；轮播为展示视图',
  ...
  AppLocale.rommSearchClear: '清除搜索',
  ...
  AppLocale.rommNoWritableFolder: '无法写入你的 ROM 文件夹。请授予 OmiSU“所有文件访问权限”后重试。',
  ...
  AppLocale.wizardArtPackTitle: '获取 OmiSU 美术包',
  AppLocale.wizardArtPackDesc:
      '我们强烈建议下载 OmiSU 系统美术包，为你的整个游戏库带来精美的'
      '主机背景。之后可在“设置”中更改。',
