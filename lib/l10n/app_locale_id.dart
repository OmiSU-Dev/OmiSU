...
const Map<String, dynamic> appLocaleId = {
  ...
  AppLocale.startupStorageUnavailable:
      'OmiSU tidak dapat mengakses folder tempat data Anda disimpan. Pastikan kartu SD atau drive terpasang.',
  AppLocale.startupStorageRetry: 'Coba lagi',
  AppLocale.startupStorageUseDefault: 'Lanjutkan tanpa itu',
  AppLocale.startupLoading:
      'Menyiapkan OmiSU. Menunggu penyimpanan dan layanan...',
  ...
  AppLocale.themesSubtitle: 'Personalisasi tampilan OmiSU',
  ...
  AppLocale.androidSystemUpdates: 'Pembaruan sistem Android',
  AppLocale.androidSystemUpdatesSubtitle:
      'Hanya pembaruan sistem Android. Membantu stabilitas dan perbaikan bug.',
  ...
  AppLocale.defaultLauncherSubtitle: 'OmiSU adalah launcher default Anda',
  AppLocale.isDefaultLauncher: 'OmiSU adalah launcher default Anda',
  AppLocale.setAsDefaultLauncher: 'Tetapkan OmiSU sebagai layar beranda',
  ...
  AppLocale.exitConfirmation: 'Apakah Anda yakin ingin keluar dari OmiSU?',
  ...
  AppLocale.thankYou: 'Terima kasih telah menggunakan OmiSU!',
  ...
  AppLocale.neoSyncDescription:
      'NeoSync adalah mitra cloud terpadu untuk OmiSU Anda.',
  AppLocale.crossPlatform: 'Lintas platform',
  AppLocale.crossPlatformDesc:
      'Lanjutkan dari tempat terakhir Anda berhenti di perangkat OmiSU mana pun.',
  ...
  AppLocale.welcomeOmiSU: 'Selamat datang di OmiSU!',
  ...
  AppLocale.storagePermissionDesc:
      'OmiSU memerlukan "Akses Semua File" untuk mengelola konfigurasi RetroArch dan menyinkronkan simpanan Anda dengan benar.\n\nHarap berikan izin ini di layar berikutnya.',
  ...
  AppLocale.chooseRomFolderDesc:
      'Pilih folder tempat file ROM Anda disimpan.\n\nOmiSU akan memindai folder ini untuk mencari game.',
  ...
  AppLocale.folderNotEmptyBody:
      'Folder ini sudah berisi {count} item. OmiSU akan menyimpan datanya sendiri di sini, bersama konten yang sudah ada.',
  ...
  AppLocale.userDataFolderGrantAllFiles:
      "Untuk memakai folder ini, izinkan akses semua file untuk OmiSU di Setelan Android → Aplikasi → Akses aplikasi khusus → Akses semua file, lalu pilih lagi.",
  AppLocale.moveUserDataTitle: 'Pindahkan Data Pengguna?',
  AppLocale.moveUserDataBody:
      'OmiSU akan memindahkan datanya sendiri — basis data, media hasil scrape, dan pengaturan — dari folder saat ini ke folder baru. Berkas yang tidak dibuat oleh OmiSU tidak akan diubah.',
  AppLocale.moveUserDataDestNotEmpty:
      'Folder baru sudah berisi {count} item. Data OmiSU akan ditambahkan di sampingnya.',
  ...
  AppLocale.restartRequiredBody:
      'OmiSU akan ditutup sekarang. Buka kembali untuk menggunakan lokasi baru.',
  ...
  AppLocale.services: 'Layanan',
  AppLocale.servicesSubtitle:
      'Hubungkan perpustakaan online dan sinkronkan — game diluncurkan dari daftar dengan core bawaan',
  AppLocale.servicesEmbeddedPlayNote:
      'OmiSU meluncurkan game secara native. Tidak perlu unduh emulator tambahan untuk sistem yang didukung.',
  ...
  AppLocale.homeLayout: 'Tata letak beranda',
  AppLocale.homeLayoutSubtitle:
      'Grid menampilkan perpustakaan sekilas; karusel adalah tampilan showcase',
  ...
  AppLocale.rommNoWritableFolder:
      'Tidak dapat menulis ke folder ROM Anda. Berikan "Akses Semua File" ke OmiSU lalu coba lagi.',
  ...
  AppLocale.wizardArtPackTitle: 'Dapatkan Paket Gambar OmiSU',
  AppLocale.wizardArtPackDesc:
      'Kami sangat menyarankan untuk mengunduh paket gambar sistem OmiSU '
