...
const Map<String, dynamic> appLocalePt = {
  ...
  AppLocale.startupStorageUnavailable:
      'O OmiSU não conseguiu acessar a pasta onde seus dados estão guardados. Verifique se o cartão SD ou a unidade está conectado.',
  ...
  AppLocale.startupLoading:
      'Preparando o OmiSU. A aguardar pelo armazenamento e pelos serviços...',
  ...
  AppLocale.themesSubtitle: 'Personalize o visual do OmiSU',
  ...
  AppLocale.defaultLauncherSubtitle: 'OmiSU é seu launcher padrão',
  AppLocale.isDefaultLauncher: 'OmiSU é seu launcher padrão',
  AppLocale.setAsDefaultLauncher: 'Definir OmiSU como sua tela de início',
  ...
  AppLocale.exitConfirmation: 'Tem certeza que deseja sair do OmiSU?',
  ...
  AppLocale.thankYou: 'Obrigado por usar o OmiSU!',
  ...
  AppLocale.neoSyncDescription:
      'NeoSync é o parceiro unificado em nuvem para seu OmiSU.',
  AppLocale.crossPlatform: 'Multiplataforma',
  AppLocale.crossPlatformDesc:
      'Continue de onde parou em qualquer dispositivo OmiSU.',
  ...
  AppLocale.welcomeOmiSU: 'Bem-vindo ao OmiSU!',
  ...
  AppLocale.storagePermissionDesc:
      'OmiSU precisa de "Acesso a Todos os Arquivos" para gerenciar suas configurações do RetroArch e sincronizar seus saves corretamente.\n\nPor favor, conceda esta permissão na próxima tela.',
  ...
  AppLocale.folderNotEmptyBody:
      'Esta pasta já contém {count} item(ns). O OmiSU irá armazenar os seus próprios dados aqui, junto com o conteúdo existente.',
  ...
  AppLocale.userDataFolderGrantAllFiles:
      "Para usar esta pasta, permita o acesso a todos os arquivos para o OmiSU em Configurações do Android → Apps → Acesso especial a apps → Acesso a todos os arquivos e selecione-a novamente.",
  AppLocale.moveUserDataTitle: 'Mover dados do usuário?',
  AppLocale.moveUserDataBody:
      'O OmiSU moverá seus próprios dados — banco de dados, mídia obtida e configurações — da pasta atual para a nova. Arquivos não criados pelo OmiSU permanecem intactos.',
  AppLocale.moveUserDataDestNotEmpty:
      'A nova pasta já contém {count} item(ns). Os dados do OmiSU serão adicionados junto a eles.',
  ...
  AppLocale.restartRequiredBody:
      'O OmiSU será fechado agora. Abra novamente para usar a nova localização.',
  ...
  AppLocale.services: 'Serviços',
  AppLocale.servicesSubtitle:
      'Ligue bibliotecas online e sincronize — os jogos iniciam da sua lista com núcleos integrados',
  AppLocale.servicesEmbeddedPlayNote:
      'OmiSU inicia jogos nativamente. Não é necessário baixar um emulador extra para sistemas suportados.',
  ...
  AppLocale.homeLayout: 'Layout inicial',
  AppLocale.homeLayoutSubtitle:
      'A grelha mostra a biblioteca; o carrossel é uma vista de destaque',
  ...
  AppLocale.rommNoWritableFolder:
      'Não foi possível gravar na sua pasta de ROMs. Conceda "Acesso a Todos os Arquivos" ao OmiSU e tente novamente.',
  ...
  AppLocale.wizardEsdeStepDesc:
      ...
      'Configurações.',
  AppLocale.wizardArtPackTitle: 'Obtenha o pacote de arte da OmiSU',
  AppLocale.wizardArtPackDesc:
      'Recomendamos fortemente baixar o pacote de arte de sistemas da OmiSU '
