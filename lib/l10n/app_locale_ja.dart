...
const Map<String, dynamic> appLocaleJa = {
  ...
  AppLocale.startupStorageUnavailable:
      'OmiSU はデータの保存先フォルダーにアクセスできませんでした。SD カードまたはドライブが接続されているか確認してください。',
  AppLocale.startupStorageRetry: '再試行',
  AppLocale.startupStorageUseDefault: 'このまま続行',
  AppLocale.startupLoading: 'OmiSU を準備中です。ストレージとサービスを待機しています…',
  ...
  AppLocale.themesSubtitle: 'OmiSUの外観をカスタマイズ',
  ...
  AppLocale.updatesUpToDate: 'すべて最新です',
  AppLocale.updatesCheckFailed:
      '更新の確認に失敗しました。Wi‑Fi を確認して再試行してください。',
  ...
  AppLocale.defaultLauncherSubtitle: 'OmiSUはデフォルトのランチャーです',
  AppLocale.isDefaultLauncher: 'OmiSUはデフォルトのランチャーです',
  AppLocale.setAsDefaultLauncher: 'OmiSUをホーム画面として設定',
  ...
  AppLocale.exitConfirmation: 'OmiSUを終了してもよろしいですか？',
  ...
  AppLocale.thankYou: 'OmiSUをご利用いただきありがとうございます！',
  ...
  AppLocale.neoSyncDescription: 'NeoSyncは、OmiSUのための統合クラウドパートナーです。',
  AppLocale.crossPlatform: 'クロスプラットフォーム',
  AppLocale.crossPlatformDesc: 'どのOmiSUデバイスからでも、続きから再開できます。',
  ...
  AppLocale.updateReleaseNotesTitle: '変更内容',
  AppLocale.updateNoReleaseNotes: 'この更新のリリースノートはありません。',
  AppLocale.updateKnownIssueWarning:
      'リリースノートに既知の問題が記載されています。更新前に下をご確認ください。',
  AppLocale.builtinPlayerUpdateAvailable: '内蔵プレイヤーの更新',
  AppLocale.builtinPlayerEngineLabel: 'LibretroDroid エンジン',
  AppLocale.builtinPlayerCoresLabel: 'Libretro コア',
  ...
  AppLocale.folderNotEmptyBody:
      'このフォルダには既に {count} 個の項目があります。OmiSU は既存の内容とともに、ここに独自のデータを保存します。',
  ...
  AppLocale.userDataFolderGrantAllFiles:
      "このフォルダを使うには、Android の設定 → アプリ → 特別なアプリアクセス → 全ファイルアクセス で OmiSU を許可してから、もう一度選択してください。",
  AppLocale.moveUserDataTitle: 'ユーザーデータを移動しますか？',
  AppLocale.moveUserDataBody:
      'OmiSU は自身のデータ（データベース、取得したメディア、設定）を現在のフォルダから新しいフォルダへ移動します。OmiSU が作成していないファイルはそのまま残ります。',
  AppLocale.moveUserDataDestNotEmpty:
      '新しいフォルダには既に {count} 個の項目があります。OmiSU のデータはそれらと一緒に追加されます。',
  ...
  AppLocale.restartRequiredBody: 'OmiSUを今すぐ終了します。新しい場所を使用するには再度開いてください。',
  ...
  AppLocale.services: 'サービス',
  AppLocale.servicesSubtitle:
      'オンラインライブラリに接続して同期 — ゲームはリストからネイティブ起動、コア内蔵',
  AppLocale.servicesEmbeddedPlayNote:
      'OmiSUはゲームをネイティブに起動します。対応システムに追加エミュレータのダウンロードは不要です。',
  ...
  AppLocale.homeLayout: 'ホームレイアウト',
  AppLocale.homeLayoutSubtitle: 'グリッドは一覧表示、カルーセルはショーケース表示',
  ...
  AppLocale.rommNoWritableFolder:
      'ROM フォルダーに書き込めませんでした。OmiSU に「すべてのファイルへのアクセス」を許可してから、もう一度お試しください。',
  ...
  AppLocale.wizardEsdeStepDesc:
      ...
      '実行できます。',
  AppLocale.wizardArtPackTitle: 'OmiSU アートパックを入手',
  AppLocale.wizardArtPackDesc:
      'ライブラリ全体で美しいコンソール背景を表示するために、OmiSU '
