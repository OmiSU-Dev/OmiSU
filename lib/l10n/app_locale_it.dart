...
const Map<String, dynamic> appLocaleIt = {
  ...
  AppLocale.startupStorageUnavailable:
      'OmiSU non è riuscito ad accedere alla cartella in cui sono salvati i tuoi dati. Verifica che la scheda SD o l\'unità sia collegata.',
  AppLocale.startupStorageRetry: 'Riprova',
  AppLocale.startupStorageUseDefault: 'Continua senza',
  AppLocale.startupLoading:
      'Preparazione di OmiSU. In attesa di archiviazione e servizi…',
  ...
  AppLocale.themesSubtitle: "Personalizza l'aspetto di OmiSU",
  ...
  AppLocale.androidSystemUpdates: 'Aggiornamenti di sistema Android',
  AppLocale.androidSystemUpdatesSubtitle:
      'Solo aggiornamenti del sistema Android. Migliora stabilità e correzioni.',
  ...
  AppLocale.defaultLauncherSubtitle: 'OmiSU è il tuo launcher predefinito',
  AppLocale.isDefaultLauncher: 'OmiSU è il tuo launcher predefinito',
  AppLocale.setAsDefaultLauncher: 'Imposta OmiSU come schermata iniziale',
  ...
  AppLocale.exitConfirmation: 'Sei sicuro di voler uscire da OmiSU ?',
  ...
  AppLocale.thankYou: 'Grazie per aver usato OmiSU !',
  ...
  AppLocale.neoSyncDescription:
      'NeoSync è il partner cloud unificato per la tua OmiSU.',
  AppLocale.crossPlatform: 'Multi piattaforma',
  AppLocale.crossPlatformDesc:
      'Continua da dove avevi interrotto su qualsiasi dispositivo OmiSU.',
  ...
  AppLocale.welcomeOmiSU: 'Benvenuto su OmiSU !',
  ...
  AppLocale.storagePermissionDesc:
      'OmiSU ha bisogno dell’"Accesso a Tutti i File" per gestire le tue configurazioni RetroArch e sincronizzare i tuoi salvataggi correttamente.\n\nPer favore, concedi questo permesso nella prossima schermata.',
  ...
  AppLocale.chooseRomFolderDesc:
      'Scegli la cartella dove sono archiviati i tuoi file ROM. OmiSU scansionerà questa cartella in cerca di giochi.',
  ...
  AppLocale.folderNotEmptyBody:
      'Questa cartella contiene già {count} elemento/i. OmiSU memorizzerà qui i propri dati, insieme ai contenuti esistenti.',
  ...
  AppLocale.userDataFolderGrantAllFiles:
      "Per usare questa cartella, consenti l'accesso a tutti i file per OmiSU in Impostazioni Android → App → Accesso speciale app → Accesso a tutti i file, poi selezionala di nuovo.",
  AppLocale.moveUserDataTitle: 'Spostare i dati utente?',
  AppLocale.moveUserDataBody:
      'OmiSU sposterà i propri dati (database, media recuperati e impostazioni) dalla cartella attuale a quella nuova. I file non creati da OmiSU restano invariati.',
  AppLocale.moveUserDataDestNotEmpty:
      'La nuova cartella contiene già {count} elemento/i. I dati di OmiSU verranno aggiunti accanto ad essi.',
  ...
  AppLocale.restartRequiredBody:
      'OmiSU verrà chiuso ora. Riaprilo per utilizzare la nuova posizione.',
  ...
  AppLocale.services: 'Servizi',
  AppLocale.servicesSubtitle:
      'Collega librerie online e sincronizza — i giochi partono dalla lista con core integrati',
  AppLocale.servicesEmbeddedPlayNote:
      'OmiSU avvia i giochi nativamente. Nessun emulatore extra è richiesto per i sistemi supportati.',
  ...
  AppLocale.homeLayout: 'Layout home',
  AppLocale.homeLayoutSubtitle:
      'La griglia mostra la libreria; il carosello è una vista in evidenza',
  ...
  AppLocale.rommNoWritableFolder:
      'Impossibile scrivere nella cartella delle ROM. Concedi l’"Accesso a Tutti i File" a OmiSU e riprova.',
  ...
  AppLocale.wizardEsdeStepDesc:
      ...
      'dalle Impostazioni.',
  AppLocale.wizardArtPackTitle: 'Ottieni il pacchetto grafico OmiSU',
  AppLocale.wizardArtPackDesc:
      'Consigliamo vivamente di scaricare il pacchetto grafico dei sistemi '
      'OmiSU per splendidi sfondi delle console in tutta la tua libreria. '
