...
const Map<String, dynamic> appLocaleEs = {
  ...
  AppLocale.startupStorageUnavailable:
      'OmiSU no pudo acceder a la carpeta donde se guardan tus datos. Comprueba que la tarjeta SD o la unidad esté conectada.',
  AppLocale.startupStorageRetry: 'Reintentar',
  AppLocale.startupStorageUseDefault: 'Continuar sin ella',
  AppLocale.startupLoading:
      'Preparando OmiSU. Esperando al almacenamiento y los servicios...',
  ...
  AppLocale.themesSubtitle: 'Personaliza la apariencia de tu OmiSU',
  ...
  AppLocale.androidSystemUpdates: 'Actualizaciones del sistema Android',
  AppLocale.androidSystemUpdatesSubtitle:
      'Solo actualizaciones del sistema Android. Mejora la estabilidad y corrige errores.',
  ...
  AppLocale.defaultLauncherSubtitle: 'OmiSU es tu lanzador por defecto',
  AppLocale.isDefaultLauncher: 'OmiSU es tu lanzador por defecto',
  AppLocale.setAsDefaultLauncher:
      'Establecer OmiSU como pantalla de inicio',
  ...
  AppLocale.exitConfirmation: '¿Seguro que quieres salir de OmiSU?',
  ...
  AppLocale.thankYou: '¡Gracias por usar OmiSU!',
  ...
  AppLocale.neoSyncDescription:
      'NeoSync es tu compañero unificado en la nube para OmiSU. Sincroniza de forma segura tus partidas y estados de juego en todos tus dispositivos, asegurando que nunca pierdas tu progreso.',
  AppLocale.crossPlatform: 'Multiplataforma',
  AppLocale.crossPlatformDesc:
      'Continúa exactamente donde lo dejaste en cualquier dispositivo con OmiSU.',
  ...
  AppLocale.welcomeOmiSU: '¡Bienvenido a OmiSU!',
  ...
  AppLocale.storagePermissionDesc:
      'OmiSU necesita "Acceso a todos los archivos" para gestionar tus configuraciones de RetroArch y sincronizar tus partidas correctamente.\n\nPor favor, concede este permiso en la siguiente pantalla.',
  ...
  AppLocale.folderNotEmptyBody:
      'Esta carpeta ya contiene {count} elemento(s). OmiSU almacenará sus propios datos aquí, junto con el contenido existente.',
  ...
  AppLocale.userDataFolderGrantAllFiles:
      "Para usar esta carpeta, permite el acceso a todos los archivos para OmiSU en Ajustes de Android → Aplicaciones → Acceso especial de aplicaciones → Acceso a todos los archivos y vuelve a elegirla.",
  AppLocale.moveUserDataTitle: '¿Mover datos de usuario?',
  AppLocale.moveUserDataBody:
      'OmiSU moverá sus propios datos (base de datos, medios extraídos y ajustes) de la carpeta actual a la nueva. Los archivos no creados por OmiSU permanecen intactos.',
  AppLocale.moveUserDataDestNotEmpty:
      'La nueva carpeta ya contiene {count} elemento(s). Los datos de OmiSU se añadirán junto a ellos.',
  ...
  AppLocale.restartRequiredBody:
      'OmiSU se cerrará ahora. Ábrela de nuevo para usar la nueva ubicación.',
  ...
  AppLocale.services: 'Servicios',
  AppLocale.servicesSubtitle:
      'Conecta bibliotecas en línea y sincroniza — los juegos se lanzan desde tu lista con núcleos integrados',
  AppLocale.servicesEmbeddedPlayNote:
      'OmiSU lanza juegos de forma nativa. No se requiere descargar un emulador extra para sistemas compatibles.',
  ...
  AppLocale.homeLayout: 'Diseño de inicio',
  AppLocale.homeLayoutSubtitle:
      'La cuadrícula muestra tu biblioteca; el carrusel es una vista destacada',
  ...
  AppLocale.rommNoWritableFolder:
      'No se pudo escribir en tu carpeta de ROMs. Concede "Acceso a Todos los Archivos" a OmiSU e inténtalo de nuevo.',
  ...
  AppLocale.wizardEsdeStepDesc:
      ...
      'desde Ajustes.',
  AppLocale.wizardArtPackTitle: 'Consigue el paquete de arte de OmiSU',
  AppLocale.wizardArtPackDesc:
      'Recomendamos encarecidamente descargar el paquete de arte de sistemas de '
      'OmiSU para tener bonitos fondos de consola en toda tu biblioteca. '
