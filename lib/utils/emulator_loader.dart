...
import 'package:omisu/services/launcher_service.dart';
import 'package:omisu/services/linux_emulator_discovery.dart';
    ...
    if (Platform.isAndroid) {
      ...
      for (final e in emulators) {
        if (e.androidPackageName != null && e.androidPackageName!.isNotEmpty) {
          try {
            const ch = MethodChannel('com.omisu.launcher/game');
            var installed =
