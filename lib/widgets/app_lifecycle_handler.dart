...
class _AppLifecycleHandlerState extends State<AppLifecycleHandler>
  ...
  void initState() {
    ...
    // GameService's channel handler). Screen-on only fires here when OmiSU
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) async {
    ...
    if (state == AppLifecycleState.resumed) {
      ...
      LibraryWatchCoordinator.instance.onAppResumed();
  ...
  /// holds it: nothing evicts on idle, so a minimised OmiSU sits on
