...
class NotificationBell extends StatefulWidget {
  const NotificationBell({super.key, this.retroGlyphs = false});

  /// When true, use JetBrains Mono Nerd Font bell glyphs (Retro 82 HUD).
  /// Behaviour — dropdown, Select, badge, arrival pulse — is unchanged.
  final bool retroGlyphs;
