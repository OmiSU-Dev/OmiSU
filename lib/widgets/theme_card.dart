...
class ThemeCard extends StatefulWidget {
  ...
  /// Optional one-line blurb under the name (e.g. palette character).
...
class _ThemeCardState extends State<ThemeCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final labelColor = widget.isFocused || widget.isSelected
                    ...
                    child: Builder(
                      builder: (context) {
                        ...
                        if (widget.themeName == 'system') {
                          themeData = AppThemes.getThemeDataByName('abyss');
                        } else {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        // Keep height parity with ThemeCard description line.
        Text(
          ' ',
          maxLines: 2,
          style: TextStyle(fontSize: 9.r, height: 1.2),
        ),
      ],
    );
  }
