...
import 'package:omisu/widgets/selection_grid/selection_grid_geometry.dart';
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: [
            OmisuAccent.focusGradient.first.withValues(alpha: 0.35),
        ...
        border: Border.all(
          width: 2.r,
          color: OmisuAccent.focusGradient[2].withValues(alpha: 0.85),
        ),
        boxShadow: [
          BoxShadow(
            color: OmisuAccent.focusGradient.first.withValues(alpha: 0.25),
            blurRadius: 16.r,
            spreadRadius: 1.r,
          ),
        ],
