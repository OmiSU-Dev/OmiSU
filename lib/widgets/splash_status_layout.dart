...
class SplashStatusLayout extends StatelessWidget {
  ...
  /// Rendered logo width in design space. Block art needs more horizontal room
  /// than the old boxed wordmark.
  static const double _logoWidth = 420;

  /// Aspect ratio of the Omarchy screensaver wordmark + boot prompt.
  static const double _logoAspect = OmisuAsciiLogo.splashAspectRatio;

  /// Share of the screen width the logo may take (block art is ~57 columns wide).
  static const double _maxLogoWidthFraction = 0.88;

  /// Share of the screen height the logo may take before it is scaled down.
  static const double _maxLogoHeightFraction = 0.48;

  /// Clear space between the block-art bottom and the boot prompt.
  static const double _gap = 28;

  /// Space between the boot prompt and detail status line.
  static const double _promptToDetailGap = 14;
  ...
  Widget build(BuildContext context) {
    ...
    final textScale = textScaleOf(context);
    final maxLogoWidth = _logoWidth * scale;
    final gap = _gap * scale;
    final promptGap = _promptToDetailGap * scale;
              ...
              child: FittedBox(
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ListenableBuilder(
                        listenable: BootStatus.instance.promptLine,
                        builder: (context, _) {
                          return Text(
                            BootStatus.instance.promptLine.value,
