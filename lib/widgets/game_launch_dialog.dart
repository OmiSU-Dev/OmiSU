...
class _GameLaunchDialogState extends State<GameLaunchDialog> {
  ...
  void dispose() {
    ...
    final skipEarlyOnGameClosed = manager.embeddedPlayActive ||
        manager.phase == GameLaunchPhase.launching;
    if (!_onGameClosedFired && !skipEarlyOnGameClosed) {
  ...
  void _closeDialog() {
    ...
    _closeCalled = true;
    final delay = GameLaunchManager().embeddedPlayActive
        ? Duration.zero
            ...
            children: [
              ...
              Align(
                ...
                child: GamepadControl(
                  ...
                  label: AppLocale.dismiss.getString(context),
