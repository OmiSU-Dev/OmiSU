...
/// Translucency tokens for OmiSU's floating chrome.
///
...
class ChromeSurface extends ThemeExtension<ChromeSurface> {
  ...
  /// More translucent chrome for OmiSU / iiSU-inspired frosted panels.
  factory ChromeSurface.glass() {
    return const ChromeSurface(
      opacity: 0.55,
      fadeLeading: 0.62,
      fadeTrailing: 0.28,
      fadeTrailingNarrow: 0.38,
    );
  }
