...
/// Corner radius tokens for OmiSU themes.
///
...
class CornerRadii extends ThemeExtension<CornerRadii> {
  ...
  /// Retro 82 / Omarchy: near-sharp corners (terminal chrome).
  factory CornerRadii.retro82() {
    return const CornerRadii(radiusExternal: 2, radiusInternal: 1);
  }
