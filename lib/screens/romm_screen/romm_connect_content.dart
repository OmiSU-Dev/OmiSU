...
class RommConnectContent extends StatefulWidget {
  ...
  /// When true, renders inside Settings without a dedicated gamepad layer and
  /// uses a compact single-column layout (iiSU onboarding style).
...
class _RommConnectContentState extends State<RommConnectContent>
  ...
  Widget build(BuildContext context) {
    ...
    final embedded = widget.embeddedInSettings;

    final form = ConstrainedBox(
      constraints: BoxConstraints(maxWidth: embedded ? 420.r : 320.r),
  ...
  Widget _wrapPanel({required Widget child, bool selected = false}) {
    return OmisuRetroPanel(active: selected, padding: EdgeInsets.all(12.r), child: child);
  }
