...
import 'package:omisu/utils/enabled_index_nav.dart';
import 'package:omisu/screens/settings_screen/new_settings_options/widgets/setting_row.dart';
import 'package:omisu/services/logger_service.dart';
import 'package:omisu/services/sfx_service.dart';
import 'package:omisu/sync/i_sync_provider.dart';
...
import 'package:omisu/widgets/delete_game_dialog.dart';
...
class GameSettingsManageTabState extends State<GameSettingsManageTab> {
  ...
  bool get _showCloudSync =>
      !NordiConfig.curatedBuild &&
      widget.syncProvider?.isAuthenticated == true;
  ...
  bool moveUp() {
    final next = _previousEnabledIndex();
