...
import 'package:omisu/screens/game_screen/my_games_carousel.dart';
import 'package:omisu/screens/game_screen/my_games_grid.dart';
...
import 'package:omisu/utils/artwork_cache.dart';
...
class GameSettingsScrappingTabState extends State<GameSettingsScrappingTab> {
  ...
  Future<void> _replaceImage(String type) async {
    ...
    try {
      // Write into OmiSU's own media folder, never over the path the
