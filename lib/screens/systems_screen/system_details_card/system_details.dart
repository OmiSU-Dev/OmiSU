...
class SystemDetailsState extends State<SystemDetails> {
  ...
  Widget _buildSystemStats(BuildContext context) {
    ...
    const neoStationDescription =
        'OmiSU is your ultimate hub for classic games. Relive the nostalgia and rediscover gaming history.';
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: isEmptyState
                ? _buildOmiSUDescription(context)
  ...
  /// Placeholder content for the default OmiSU introduction.
  Widget _buildOmiSUDescription(BuildContext context) {
    return Container(
      width: double.infinity,
      padding: EdgeInsets.all(16.r),
      decoration: BoxDecoration(
