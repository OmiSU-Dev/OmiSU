...
import 'package:omisu/models/collection_model.dart';
...
import 'package:omisu/utils/collection_sort.dart';
import 'package:omisu/services/collections/collections_service.dart';
...
import 'package:omisu/widgets/omisu/omisu_back_footer.dart';
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            OmisuBackFooterBar(onBack: _goBack),
          ],
        ),
      ),
    );
