...
import 'package:omisu/services/retro_achievements_cache.dart';
import 'package:omisu/services/screenscraper/media_resolver.dart';
...
class UserDataLocationService {
  ...
  /// Whether OmiSU can create and delete a file inside [dirPath],
  ...
  /// Top-level entry names under the user-data directory that OmiSU
  ...
  /// Migrates OmiSU's own user data from [sourceUserDataPath] to
  /// [destPath], then removes the migrated copies from the source.
  ///
  /// Only OmiSU-owned entries (see [_isOwnedEntry]) are copied or deleted.
