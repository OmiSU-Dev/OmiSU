...
class GameService {
  ...
  /// Screens that own media need it because OmiSU runs as a HOME launcher:
  ...
  static void initializeAndroidGameListener() {
    ...
    platform.setMethodCallHandler((call) async {
      if (call.method == 'onGameReturned') {
        ...
        unawaited(MenuAmbientService.instance.appPaused());
        ...
        if (!GameSessionManager.isGameLaunched) {
          ...
          unawaited(MenuAmbientService.instance.appResumed());
