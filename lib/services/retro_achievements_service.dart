...
class RetroAchievementsService {
  ...
  /// Mapping of OmiSU system identifiers to RetroAchievements console IDs.
  ...
  /// Returns the RetroAchievements console ID for a given OmiSU system name.
