...
class FavoritesService {
  ...
  /// Keeps [SqliteDatabaseProvider]'s in-memory cache aligned after a play
  /// write. Wired from [main] at startup — the home recent card reads the
  /// provider, not SQLite directly.
  static Future<void> Function(String romPath)? onRomPlayedRecorded;
  ...
  static Future<void> recordGamePlayed(GameModel game) async {
    ...
    await GameRepository.recordRomPlayedByPath(romPath);
    await onRomPlayedRecorded?.call(romPath);
  }
