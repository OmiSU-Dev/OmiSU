...
class MetadataCleanupResult {
  ...
  /// Items that were actually deleted (OmiSU-owned rows only).
  ...
  /// Number of media files removed from OmiSU's `media/` directory.
...
///
/// Only OmiSU-generated metadata is physically cleaned: its database row
/// and any files living inside OmiSU's own `media/` folder are removed.
...
class MetadataCleanupService {
  ...
  /// Removes OmiSU-owned orphaned metadata and its physical media files.
