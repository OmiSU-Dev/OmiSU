...
/// - Automatic system mapping between OmiSU and ScreenScraper IDs.
...
class ScreenScraperService {
  ...
  static Future<Map<String, dynamic>?> verifyCredentials(
    ...
    try {
      ...
      final response = await ScreenscraperClient.httpGetWithRetry(
        url,
        headers: {'User-Agent': 'OmiSU/1.0', 'Accept': 'application/json'},
      );
  ...
  static bool get isMetadataScrapingRunning => _isMetadataScrapingRunning;
  ...
  /// Maps a raw API response to the OmiSU metadata schema.
  ///
