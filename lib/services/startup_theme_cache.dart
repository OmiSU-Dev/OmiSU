...
class StartupThemeColors {
  ...
  /// Abyss chrome — what a first launch (empty cache) paints, and the fallback
  /// whenever the cache cannot be read. Values mirror `abyss_theme.dart` so a
  /// default install shows no handoff at all.
  static const fallback = StartupThemeColors(
    background: Color(0xFF000611),
    foreground: Color(0xFFffd6a7),
