...
import 'package:omisu/services/custom_theme_service.dart';
...
class ThemeProvider extends ChangeNotifier with WidgetsBindingObserver {
  ...
  ThemeData _currentTheme = AppThemes.abyssTheme;

  /// Internal identifier for the current theme. Set to 'system' for dynamic mode.
  String _currentThemeName = 'abyss';
  ...
  ThemeData get currentTheme {
    // OmiSU brand default: Abyss everywhere, including "system" mode.
    if (_currentThemeName == 'system') {
      return availableThemes['abyss']!;
    }
  ...
  static final Map<String, ThemeData> availableThemes = {
    ...
    'retro82': AppThemes.retro82Theme,
    'omarchy': AppThemes.omarchyTheme,
    'solitude': AppThemes.solitudeTheme,
    'vantablack': AppThemes.vantablackTheme,
    'ethereal': AppThemes.etherealTheme,
    'everforest': AppThemes.everforestTheme,
    'gruvbox': AppThemes.gruvboxTheme,
    'hackerman': AppThemes.hackermanTheme,
    'kanagawa': AppThemes.kanagawaTheme,
    'catppuccin': AppThemes.catppuccinTheme,
  };
  ...
  /// Short blurb shown under each theme name in Settings.
  static const Map<String, String> themeDescriptions = {
    'system': 'Follows Abyss as the brand default',
    'dark': 'Deep charcoal with cool accents',
    'light': 'Clean bright daylight UI',
    'oled': 'True black for OLED panels',
    'valentine': 'Soft pink romantic pastels',
    'dracula': 'Classic purple gothic night',
    'nord': 'Arctic cool blue-greys',
    'coffee': 'Warm espresso browns',
    'tokyo_night': 'Night-city indigo blues',
    'retro': 'Vintage terminal greens',
    'abyss': 'Deep-sea blues and teal',
    'cyberpunk': 'Neon magenta on black',
    'aqua': 'Bright cyan water tones',
    'palenight': 'Muted indigo dusk',
    'horizon': 'Warm sunset oranges',
    'retro82': 'CRT amber on deep navy',
    'omarchy': 'Soft rose on warm light',
    'solitude': 'Quiet magenta on charcoal',
    'vantablack': 'Pitch black OLED-ready',
    'ethereal': 'Misty peach on dark stone',
    'everforest': 'Soft forest greens',
    'gruvbox': 'Warm retro earth tones',
    'hackerman': 'Neon green terminal vibe',
    'kanagawa': 'Golden waves and coral',
    'catppuccin': 'Soft pastels on deep blue',
  };
  ...
  void _updateSystemTheme() {
    _currentTheme = availableThemes['abyss']!;
  }
  ...
  List<Map<String, String>> getThemeList() {
    final list = availableThemes.keys.map((key) {
      return {
        ...
        'description': themeDescriptions[key] ?? '',
      };
    }).toList();
