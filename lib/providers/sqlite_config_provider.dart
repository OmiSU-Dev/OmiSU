...
import '../services/auto_scrape_coordinator.dart';
import '../services/library_watch_coordinator.dart';
...
class SqliteConfigProvider extends ChangeNotifier with WidgetsBindingObserver {
  ...
  static const _secondaryDisplayChannel = MethodChannel(
    'com.omisu.launcher/secondary_display',
  );
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      if (_config.scanOnStartup) {
        ...
        _queueAutoScrapeForSystems(
          _detectedSystems.map((s) => s.folderName),
        );
      }
